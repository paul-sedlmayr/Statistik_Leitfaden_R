...
**Tabelle**: Typische Interpretation von Cohen’s $d$ gemäß gängiger Konventionen (Cohen, 1988).
...
**Tabelle**: Typische Interpretation von Eta-Quadrat gemäß Konventionen (Cohen, 1988).
...
**Tabelle**: Typische Interpretation der Pearson-Korrelation $r$ gemäß Konventionen (Cohen, 1988).
...
Die Power beschreibt die Wahrscheinlichkeit, einen Effekt zu finden, wenn es diesen wirklich in der Population gibt. Die Power hängt von den folgenden Parametern ab:
- Stichprobengröße `n`
...
Für die Power-Analyse in ANOVA müssen wir das Effektstärkenmaß $\eta^2$ zu erst umrechnenen, um $f$ zu bestimmen. $f$ ist das Verhältnis der Standardabweichung der Gruppenmittelwerte in der Population ($\sigma_{\mu}$) zu Standardabweichung innerhalb ($\sigma$).
