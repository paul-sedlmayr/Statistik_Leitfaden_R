...
```{r}
df$numerical_ability_cent <- as.vector(scale(df$numerical_ability, center = TRUE, scale = FALSE))
df$WMS4_delayed_recall_cent <- as.vector(scale(df$WMS4_delayed_recall, center = TRUE, scale = FALSE))
